...
const cards = [
  {
    ...
    body: [
      ...
      row(395, ["⌥", "H", "J", "K", "L"], "Focus left / down / up / right", 510, true),
      row(480, ["⌥", "⇧", "H", "J", "K", "L"], "Move left / down / up / right", 570, true),
      ...
      row(905, ["⌥", "⇧", "SPACE"], "Toggle floating / tiling", 440),
  ...
  },
  {
    ...
    body: [
      ...
      row(605, ["⌥", "TAB"], "Previous workspace", 465),
      row(705, ["⌥", "⇧", "TAB"], "Move workspace to next monitor", 465, true),
      row(805, [{ label: "3-FINGER HORIZONTAL", width: 370 }], "Previous / next occupied", 465, true),
      row(905, ["⌥", "ENTER"], "Open Ghostty + Herdr", 465),
      section("PERSONAL PROFILE", 1055),
      text(72, 1125, "1  Ghostty    ·    2  VSCodium    ·    3  Zen", "action"),
      text(72, 1435, "⌥  Option     ⇧  Shift     TAB  Tab", "muted"),
    ].join("\n\n"),
  },
  {
